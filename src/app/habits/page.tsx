...
import HabitWeeklyOverview from '@/components/habits/HabitWeeklyOverview';
import DayHabitCard from '@/components/habits/DayHabitCard';
import {
    Flame,
    Plus,
    Check,
...
type ViewMode = 'table' | 'daily' | 'weekly';
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2 bg-white/5 rounded-lg p-1">
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-colors ${viewMode === 'table'
